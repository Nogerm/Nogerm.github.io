...
VirtualJoystick.prototype.up	= function(){
	...
	if(( Math.abs(deltaY) < 10  ) || ( Math.abs(deltaX) < 10  ) || ( deltaY >= 0 ) || ( Math.abs(deltaX) > Math.abs(deltaY) ))	
	{
		return false;
	}
	else
...
VirtualJoystick.prototype.down	= function(){
	...
	var deltaX	= this.deltaX();
	var deltaY	= this.deltaY();
	if(( Math.abs(deltaY) < 10  ) || ( Math.abs(deltaX) < 10  ) || ( deltaY <= 0 )|| ( Math.abs(deltaX) > Math.abs(deltaY) ))		return false;
	else
